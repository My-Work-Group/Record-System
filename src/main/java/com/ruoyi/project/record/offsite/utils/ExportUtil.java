package com.ruoyi.project.record.offsite.utils;

import com.ruoyi.common.utils.XWPFHandler.WordTemplate;
import com.ruoyi.project.record.common.CommonCaseFile;
...
public class ExportUtil {
    ...
    private CommonCaseFile caseFile;
    ...
    public static String getDocxTemplatesPath(String object, int docxFileId) {
        String docxTemplatesFile;
        String path = getJarPath() + "\\docxTemplate\\offsite\\";
    ...
    public static String getJarPath() {
        //jar包编译后的相对路径
        String path = ExportUtil.class.getProtectionDomain().getCodeSource().getLocation().getFile();
        //消除乱码
        try {
