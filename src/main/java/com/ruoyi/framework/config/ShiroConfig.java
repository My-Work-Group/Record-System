...
public class ShiroConfig
{
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager)
    {
        ...
        filterChainDefinitionMap.put("/icon.ico**", "anon");
        filterChainDefinitionMap.put("/logo.ico**", "anon");
        filterChainDefinitionMap.put("/info_edit.png**", "anon");
        filterChainDefinitionMap.put("/icon.png**", "anon");
        filterChainDefinitionMap.put("/institution_name.png**", "anon");
        filterChainDefinitionMap.put("/slogan.png**", "anon");
